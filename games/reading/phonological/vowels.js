...
"Accordion" levels — the user stretches a short-vowel word into a
long-vowel word (Silent E rule), using a magic wand trigger and a
picture cue for each word.
"Sort" levels — the game speaks a word out loud AND shows its emoji,
...
function nextRound() {
    if (levelIndex < gameData.length - 1) {
        ...
        if (window.GameHub?.showComplete) {
            ...
            alert("Vowel Master! You've mastered stretching AND sorting long and short vowel sounds!");
        }
    }
}
        ...
        stage.innerHTML = `
            ...
            <div class="game-stage">
              <div class="sort-container">
                <div class="status-row">
                    <button id="prev-btn" style="background:none; border:none; cursor:pointer; font-size:1.2rem; color:#4A5568; visibility: ${levelIndex > 0 || roundIdx > 0 ? 'visible' : 'hidden'};">⬅️ Previous</button>
                    <div class="level-indicator">Level ${levelIndex + 1} / ${totalLevels}</div>
