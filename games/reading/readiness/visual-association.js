...
(function() {
    ...
    window.initGame = function(containerId) {
        ...
        promptContainer.style.cssText = `background: #F7FAFC; padding: 20px; border-radius: 50%; border: 5px solid #4A90E2; margin-bottom: 20px; width: 120px; height: 120px; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 15px rgba(0, 0, 0, 0.05);`;
    ...
    function renderRound() {
        ...
        let currentPair;
        if (levelIndex < 5) {
            currentPair = toolPairs[levelIndex];
        } else if (levelIndex < 10) {
            currentPair = contextPairs[levelIndex - 5];
        } else {
            currentPair = advancedPairs[levelIndex - 10];
        }
